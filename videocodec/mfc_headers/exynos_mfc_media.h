...
#define V4L2_CID_MPEG_VIDEO_SRC_BUF_FLAG (V4L2_CID_MPEG_MFC_BASE + 30)
#define V4L2_CID_MPEG_VIDEO_DST_BUF_FLAG (V4L2_CID_MPEG_MFC_BASE + 31)
#define V4L2_CID_MPEG_VIDEO_FRAME_ERROR_TYPE (V4L2_CID_MPEG_MFC_BASE + 33)
#define V4L2_CID_MPEG_VIDEO_PRIORITY (V4L2_CID_MPEG_MFC_BASE + 36)
#define V4L2_CID_MPEG_VIDEO_CHROMA_QP_OFFSET_CB (V4L2_CID_MPEG_MFC_BASE + 38)
#define V4L2_CID_MPEG_VIDEO_CHROMA_QP_OFFSET_CR (V4L2_CID_MPEG_MFC_BASE + 39)
...
#ifndef MAINLINE_FEATURE_IN_SINCE_4_19
